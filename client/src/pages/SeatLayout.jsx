          ...
          <button
            onClick={() => {
              if (selectedSeats.length === 0) {
                toast("Please select at least 1 seat")
              } else {
                navigate('/my-bookings')
              }
            }}
            className='flex items-center gap-2 px-6 py-2 text-sm bg-primary hover:bg-primary-dull transition rounded-full font-medium text-white shadow-md active:scale-95'
          >
            Proceed to Checkout
